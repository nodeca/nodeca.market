...
module.exports = function (N, apiPath) {
  ...
  N.wire.on(apiPath, async function prepare_locals(params) {
    ...
    params.log_templates = {
      body: 'common.abuse_report.market_item_wish.log_templates.body',
      subject: 'common.abuse_report.market_item_wish.log_templates.subject'
    };

    params.email_templates = {
      body: 'common.abuse_report.market_item_wish.email_templates.body',
      subject: 'common.abuse_report.market_item_wish.email_templates.subject'
    };

    locals.project_name = await N.settings.get('general_project_name');
    locals.report_text = params.report.text;
    locals.item_url = N.router.linkTo('market.item.wish', {
