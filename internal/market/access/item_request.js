...
// In:
//
// - params.items - array of models.market.ItemRequest. Could be plain value
...
module.exports = function (N, apiPath) {
  ...
  //
  N.wire.on('internal:common.access', async function check_market_item_request_access(access_env) {
    ...
    await N.wire.emit('internal:market.access.item_request', access_env_sub);
