...
N.wire.on('navigate.done:' + module.apiPath, function market_load_previously_selected_items() {
  selected_items_key = `market_selected_items_${N.runtime.user_hid}_${pageState.hid}`;
...
//
N.wire.on('navigate.exit:' + module.apiPath, function topic_item_selection_teardown() {
  $(document)
    .off('keyup', key_up)
