...
N.wire.once(module.apiPath, function init_handlers() {
  ...
  //
  N.wire.on(module.apiPath + ':submit', function submit_item_delete_dlg(form) {
...
// Init dialog
//
N.wire.on(module.apiPath, function show_item_delete_dlg(options) {
  params = options;
