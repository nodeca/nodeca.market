...
function load(start, direction) {
  ...
  return N.io.rpc('market.search.buy.results',
...
N.wire.on('navigate.done:' + module.apiPath, function page_setup() {
  ...
  N.io.rpc('market.search.buy.results',
    ...
    return N.wire.emit('common.blocks.navbar.blocks.page_progress:update', {
      ...
      let $html = $(N.runtime.render('market.search.buy.results', res));
      ...
      return N.wire.emit('navigate.content_update', {
        ...
        scrollable_list = new ScrollableList({
          N,
          list_selector:               '.market-search-buy__item-list',
          item_selector:               '.market-list-item-offer',
          placeholder_bottom_selector: '.market-search-buy__loading-next',
