...
module.exports = function (N) {
  ...
  async function market_item_offer_gc_handler(userId, contentId, categoryId, max, currentCut) {
  ...
  async function market_item_wish_gc_handler(userId, contentId, categoryId, max, currentCut) {
