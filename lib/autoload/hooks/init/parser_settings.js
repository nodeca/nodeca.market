// Create parser settings for market application. Use `markup` schema as template.
//
...
module.exports = function (N) {
  N.wire.before('init:models', function init_market_parser_settings() {
    const SETTINGS_PREFIX = 'market_items_';
    const CATEGORY_KEY = 'market_items_markup';
    const GROUP_KEY = 'market_editor';
