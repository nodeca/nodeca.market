...
module.exports = function (N) {
  N.wire.on('init:jobs', function register_market_items_rebuild() {
    ...
    N.queue.registerTask({
      ...
      init() {
        return [
          N.queue.market_item_offers_active_rebuild(),
          N.queue.market_item_offers_closed_rebuild(),
          N.queue.market_item_wishes_active_rebuild(),
          N.queue.market_item_wishes_closed_rebuild()
        ];
      }
    });
